...
class FetchJeepTest extends FetchJeepTestSupport {
  ...
  class TestsThatDoNotPolluteTheApplicatonContext extends FetchJeepTestSupport{
    @Test
  ...
  static Stream<Arguments> parametersForInvalidInput() {
    //@formatter:off
    return Stream.of(
        arguments("WRANGLER", "@jklsdf", "Trim contains non-alpha-numeric characters"),
  ...
  @Sql(scripts = {
      ...
      "classpath:flyway/migrations/V1.1__Jeep_Data.sql"},
      config = @SqlConfig(encoding = "utf-8"))
  class TestsThatPolluteTheApplicatonContext extends FetchJeepTestSupport{
    @MockBean
    ...
    void testThatAnUnplannedErrorResultsInA500Status() {
      //Given: a valid model, trim, and URI
       ...
       doThrow(new RuntimeException("Opps!")).when(jeepSalesService).fetchJeeps(model, trim);
